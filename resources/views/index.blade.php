...
<html lang="{{ config('app.locale') }}">
    ...
    <body>
      <div class="wrapper" id="app">
        <cards @open="openModal" :show-modal="showModal"></cards>
        ...
        <!--  </div>            -->
        <modal :show-modal="showModal" :modal-data="modalData" v-if="showModal" @close="closeModal"></modal>
        <button @click="getNewPosts(this.meta.max_id)">next</button>
      </div>
